...
![Alt text](images/Embedding_Loss.jpg "Loss from Embedding training")
![Alt text](images/Classification_Loss.jpg "Loss from Classifier Training")

Due to the massive imbalance in the classes, getting an 'accuracy of 0.8' as per the task requirements would be very simple as a classifier that predicted benign each time would get an accuracy of 0.983. The overall accuracy of the classifier was  The results in some other metrics are shown below:
